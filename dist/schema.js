...
const googleAuth_resolver_1 = require("./resolvers/googleAuth.resolver");
...
const createSchema = () => (0, type_graphql_1.buildSchema)({
    resolvers: [user_resolver_1.UserResolver, mentor_resolver_1.MentorResolver, common_resolver_1.CommonResolver, message_resolver_1.MessageResolver, googleAuth_resolver_1.GoogleAuthResolver, twitterAuth_resolver_1.TwitterAuthResolver, githubAuth_resolver_1.GithubAuthResolver],
    validate: false,
